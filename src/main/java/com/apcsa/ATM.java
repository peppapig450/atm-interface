...
public class ATM implements Overdraft {
    ...
    public static Customer mainMenuPrompt(Bank theBank, Scanner sc) {
        ...
        do {
            ...
            // attempt to get the customer object corresponding to the entered ID and pin
            // combo
    ...
    public static void customerMenu(Customer user, Scanner sc) {
        ...
        switch (choice) {
            ...
            case 4:
                ...
                break;
            case 5:
                System.out.println("Please contact your branch to discuss available overdraft options."); // overdraft
                                                                                                          // options
    ...
    public static void withdrawFunds(Customer user, Scanner sc) {
        ...
        if (user.numAccounts() != 1) {
            ...
            } while (withdrawAccount < 0 || withdrawAccount >= user.numAccounts()); // loop until valid response is
                                                                                    // given
        } else {
            withdrawAccount = 1;
        }
